...
const getMarket = async ({
  ...
  const total =
    parseFloat(Web3.utils.fromWei(_market[1], "ether")) +
    parseFloat(Web3.utils.fromWei(_market[2], "ether"));

  const noPercentage =
    (parseFloat(Web3.utils.fromWei(_market[2], "ether")) / total) * 100;
  const yesPercentage =
    (parseFloat(Web3.utils.fromWei(_market[1], "ether")) / total) * 100;
...
export const PolyAppContextProvider: React.FC<{ children: ReactNode }> = ({
  children,
}) => {
